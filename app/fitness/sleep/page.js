        ...
        <div style={s.page}>
          ...
          <div style={s.body}>
            <div style={s.card}>
              ...
              <div style={s.desc}>Duration · Quality · Trends</div>
              <div style={s.hint}>Ask NOMIS about sleep in the meantime →</div>
            </div>
          </div>
        </div>
      </main>
      <NomisChat pageContext="User is on the SLEEP page. Module coming in Drop 5." />
    </div>
  )
}
