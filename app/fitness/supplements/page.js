        ...
        <div style={s.page}>
          ...
          <div style={s.body}>
            <div style={s.card}>
              ...
              <div style={s.title}>SUPPLEMENTS</div>
              <div style={s.sub}>Coming in Drop 4</div>
              <div style={s.desc}>Stack · Timing · Analysis</div>
              <div style={s.hint}>Ask NOMIS about supplements in the meantime →</div>
            </div>
          </div>
        </div>
      </main>
      <NomisChat pageContext="User is on the SUPPLEMENTS page. Module coming in Drop 4." />
    </div>
  )
}
