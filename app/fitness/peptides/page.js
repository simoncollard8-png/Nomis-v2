      ...
      <main className="main-content">
        <div style={s.page}>
          <header className="pwa-header" style={s.header}>
            ...
            <div className="page-sub">Cycle tracking · Dosing · Logs</div>
          </header>
          <div className="progress-track"><div className="progress-fill" style={{ width:'0%' }} /></div>
          <div style={s.body}>
            <div style={s.card}>
              <div style={s.icon}>💉</div>
              <div style={s.title}>PEPTIDES</div>
              <div style={s.sub}>Coming in Drop 4</div>
              <div style={s.desc}>Cycle tracking · Dosing · Logs</div>
              <div style={s.hint}>Ask NOMIS about peptides in the meantime →</div>
            </div>
          </div>
        </div>
      </main>
      <NomisChat pageContext="User is on the PEPTIDES page. Module coming in Drop 4." />
    </div>
  )
}
