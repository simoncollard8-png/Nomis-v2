      ...
      <main className="main-content">
        <div style={s.page}>
          <header className="pwa-header" style={s.header}>
            ...
            <div className="page-sub">Weight · Measurements · Progress photos</div>
          </header>
          ...
          <div style={s.body}>
            <div style={s.card}>
              ...
              <div style={s.desc}>Weight · Measurements · Progress photos</div>
              <div style={s.hint}>Ask NOMIS about body in the meantime →</div>
            </div>
          </div>
        </div>
      </main>
      <NomisChat pageContext="User is on the BODY page. Module coming in Drop 5." />
    </div>
  )
}
