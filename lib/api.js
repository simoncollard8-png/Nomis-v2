...
export async function getTodaysWorkout() {
  ...
  // First check user_schedule — this is what the user set manually
  try {
    ...
    if (scheduleRows.length) {
      ...
      // Map user-friendly schedule names to exercise muscle_group values in DB
      ...
      // Fetch all exercises and filter client-side since Supabase eq filter is single value
      ...
      // No exercises in DB for this group yet — return shell with muscle group
  ...
  // Fall back to programs/workout_plans if no user_schedule
